...
class ProductTest < ActiveSupport::TestCase
  ...
  test "Should not save without serving size" do
    without_serving_size = Product.new({
      name: "name",
      category: "category",
      serving_unit: "g",
      ndb_no: 123456
  ...
  test "Should not save if serving size is a string" do
    string_serving_size = Product.new({
      name: "name",
      category: "category",
      serving_size: "string",
      serving_unit: 'g',
    ...
    assert_not string_serving_size.save, "Product saved with a string for serving size!"
  end

  test "Should not save without serving unit" do
    without_serving_unit = Product.new({
      name: "name",
      category: "category",
      serving_size: 1,
      ndb_no: 123456
  ...
  test "Should not save if ndb number already in database" do
    duplicate_ndb_no = Product.new({
      name: "name",
      category: "category",
      serving_size: 1,
      serving_unit: "g",
      ndb_no: products(:beets)
    })
