...
ActiveRecord::Schema.define(version: 20160315191706) do
  ...
  add_index "nutrients", ["name"], name: "index_nutrients_on_name", using: :btree
  ...
  add_index "products", ["ndb_no"], name: "index_products_on_ndb_no", using: :btree
